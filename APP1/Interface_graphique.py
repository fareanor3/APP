...
mode_2.place(x=0,y=300, width=225, height=75)
mode_3 = Button(fen1, text="la_bataille_d_addition_26tours",command=clic_3)
mode_3.place(x=225,y=300, width=225, height=75)
...
mode_7.place(x=225,y=150, width=225, height=75)
mode_8 = Button(fen1, text="bataille_decouverte_26tours",command=clic_8)
mode_8.place(x=225,y=225, width=225, height=75)
